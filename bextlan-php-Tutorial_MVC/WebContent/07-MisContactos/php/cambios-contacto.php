...
<form id="cambio-contacto" name="cambio_frm"
	action="php/modificar-contacto.php" method="post"
	...
	<fieldset>
		...
		<div>
			<label for="contacto-lista">Contacto: </label> <select
				id="contacto-lista" class="cambio" name="contacto_slc" required>
				<option value="">- - -</option>
		...
		if ($_GET ["contacto_slc"] != null) {
			...
			$ejecutar_consulta_contacto = $conexion->query ( $consulta_contacto );
